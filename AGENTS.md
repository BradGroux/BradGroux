...
- Keep `Connect` as one centered row of the seven colored `for-the-badge` Shields links. Do not replace it with a table, generic `<kbd>` boxes, spacer images, or a multi-row layout.
